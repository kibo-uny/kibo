...
public class YourService extends KiboRpcService {
    ...
    private double QUAT_1_P11_z = -90;
    private double QUAT_2_P11_z = 0;
    private double QUAT_3_P11_z = -90;
    private double QUAT_4_P11_x = -11.31;
    private double QUAT_5_P11_z = 0;
    ...
    protected void runPlan1(){
        ...
        for (int i = 0; i < arrayPoint.length; i++) {
            ...
            if(arrayQuat[i] != -11.31) {
                eulerToQuaternion(0, 0, arrayQuat[i]);
            }
            else {
                eulerToQuaternion(arrayQuat[i], 0, 0);
            }

            final Quaternion quatesrnion = new Quaternion((float)qua_x, (float)qua_y, (float)qua_z, (float)qua_w);
	...
	private void eulerToQuaternion(double r, double p, double y){
